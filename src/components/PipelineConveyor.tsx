...
export default function PipelineConveyor({
  ...
  return (
    <div
      className={`relative w-full px-4 py-16 bg-gray-900 text-white overflow-hidden ${className}`}
    >
      {/* Animated beam track */}
      <AnimatedBeam
      ...
      <div className="relative z-10 mx-auto max-w-5xl">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">
            A visual representation of the workflow pipeline with animated
        ...
        <div className="bg-gray-800/30 rounded-xl p-4 mb-10 relative overflow-hidden">
          ...
          <Marquee className="py-2" gradient={false}>
